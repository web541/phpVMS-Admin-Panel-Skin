...
<dd><input class="form-control" id="airporticao" name="icao" type="text" value="<?php echo $airport->icao?>" /> 
...
<dt>Airport Name *</dt>
<dd><input class="form-control" id="airportname" name="name" type="text" value="<?php echo $airport->name?>" /></dd>

<dt>Country Name *</dt>
<dd><input class="form-control" id="airportcountry" name="country" type="text" value="<?php echo $airport->country?>"  /></dd>

<dt>Latitude *</dt>
<dd><input class="form-control" id="airportlat" name="lat" type="text" value="<?php echo $airport->lat?>" /></dd>

<dt>Longitude *</dt>
<dd><input class="form-control" id="airportlong" name="lng" type="text" value="<?php echo $airport->lng?>" /></dd>

<dt>Chart Link</dt>
<dd><input class="form-control" id="chartlink" name="chartlink" type="text" value="<?php echo $airport->chartlink?>" /></dd>

<dt>Fuel Price *</dt>
<dd><input class="form-control" id="fuelprice" name="fuelprice" type="text" value="<?php echo $airport->fuelprice?>" />
