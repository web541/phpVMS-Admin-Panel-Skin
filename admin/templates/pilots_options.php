...
<dl>
	...
	<dd><input type="password" class="form-control" name="password1" /></dd>
	
	<dt>Enter password again</dt>
	<dd><input type="password" class="form-control" name="password2" /></dd>
	
	<dt></dt>
    <br />
	<dd><input type="hidden" name="pilotid" value="<?php echo $pilotid;?>" />
		<input type="hidden" name="action" value="changepassword" />
		<input type="submit" name="submit" class="btn btn-success btn-block" value="Change Password" /></dd>
</dl>
</form>
<?php
}
...
<dl>	
	...
	<dd><input type="hidden" name="pilotid" value="<?php echo $pilotid;?>" />
		...
		<input type="submit" name="submit" onclick="return doublecheck();" class="btn btn-danger btn-block" value="Delete Pilot" /></dd>
</dl>
</form>
<?php
}
