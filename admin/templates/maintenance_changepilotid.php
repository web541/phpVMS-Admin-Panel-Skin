...
<b>Select Pilot:</b><br />
<select class="form-control" name="old_pilotid">
...
<input type="text" class="form-control" name="new_pilotid" value="" />
<br />
<p><b>Are you sure?</b></p>
<input type="submit" name="submit" class="btn btn-success" value="Confirm Change ID" />
</form>
