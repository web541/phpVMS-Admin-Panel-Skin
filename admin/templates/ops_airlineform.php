...
<dl>
<dt>Airline Code *</dt>
<dd><input class="form-control" name="code" type="text" value="<?php echo $airline->code; ?>" /></dd>

<dt>Airline Name *</dt>
<dd><input class="form-control" name="name" type="text" value="<?php echo $airline->name; ?>" /></dd>
