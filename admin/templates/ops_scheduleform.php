...
<tr>
	...
	<td>
		<input class="form-control" type="text" name="flightnum" value="<?php echo $schedule->flightnum;?>" />
	</td>
</tr>
<tr>
	<td width="3%" nowrap><strong>Departure Airport:</strong></td>
	<td><input id="depicao" name="depicao" class="form-control" value="<?php echo $schedule->depicao;?>" onclick="" />
	</td>
</tr>
<tr>
	<td><strong>Arrival Airport:</strong></td>
	<td><input id="arricao" name="arricao" class="form-control" value="<?php echo $schedule->arricao;?>" onclick="" />
	</td>
</tr>
<tr>
...
<tr>
	...
	<td><input class="form-control" type="text" name="flightlevel" value="<?php echo $schedule->flightlevel?>" />
...
<tr>
	...
	<td><input class="form-control" type="text" name="price" value="<?php echo $schedule->price?>" />
...
<tr>
	...
	<td><input class="form-control" type="text" name="payforflight" value="<?php echo $schedule->payforflight?>" />
