...
<tr>
	...
	if(Config::Get('RANKS_AUTOCALCULATE') == false)
	{
		...
		{
			echo "<option class='form-control' value=\"{$rank->rankid}\">{$rank->rank}</option>";
		}
		echo '</select>';
	}
	else
...
<tr>
	...
	<td><?php echo $pilotinfo->totalhours;?>
		<input type="hidden" class="form-control" name="totalhours" value="<?php echo $pilotinfo->totalhours;?>" />
	</td>
</tr>
<tr>
