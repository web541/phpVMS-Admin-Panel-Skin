...
<table id="tabledlist" class="table" style="float: left">
<thead>
	<tr>
...
<tr>
	<td>First Name</td>
	<td><input type="text" class="form-control" name="firstname" value="<?php echo $pilotinfo->firstname;?>" /></td>
</tr>

<tr>
	<td>Last Name</td>
	<td><input type="text" class="form-control" name="lastname" value="<?php echo $pilotinfo->lastname;?>" /></td>
</tr>
<tr>
	<td>Email Address</td>
	<td><input type="text" class="form-control" name="email" value="<?php echo $pilotinfo->email;?>" /></td>
</tr>
<tr>
	<td>Airline</td>
	<td>
...
<tr>
	<td>Total Flights</td>
	<td><input type="text" class="form-control" name="totalflights" value="<?php echo $pilotinfo->totalflights;?>" /></td>
</tr>
<tr>
	<td>Transfer Hours</td>
	<td><input type="text" class="form-control" name="transferhours" value="<?php echo $pilotinfo->transferhours;?>" /></td>
</tr>
<tr>
	<td>Total Pay</td>
	<td><input type="text" class="form-control" name="totalpay" value="<?php echo $pilotinfo->totalpay;?>" /></td>
</tr>
<tr>
	<td>Pay Adjustment</td>
	<td><input type="text" class="form-control" name="payadjust" value="<?php echo $pilotinfo->payadjust;?>" /></td>
</tr>
<tr>
	<td>Pilot active?</td>
	<td><select class="form-control" name="retired">
        <?php 
...
<tr>
	<td>Admin Comment</td>
	<td><textarea style="width: 100%; height: 70px;" class="form-control" name="comment"><?php echo $pilotinfo->comment;?></textarea>
</tr>
<tr>
<?php
if($customfields) {
...
?>
	<tr>
		...
		if($field->type == 'dropdown') {
			...
			echo '<textarea class="form-control" name="'.$field->fieldname.'" style="width: 400px; height: 100px" class="customfield_textarea">'.$field->value.'</textarea>';
		} else {
