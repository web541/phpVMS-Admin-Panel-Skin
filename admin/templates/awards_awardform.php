...
<dl>
	<dt>Award Name</dt>
	<dd><input name="name" class="form-control" type="text" value="<?php echo $award->name;?>" /></dd>
	
	<dt>Description</dt>
	<dd><input name="descrip" class="form-control" type="text" value="<?php echo $award->descrip;?>" /></dd>
		
	<dt>Image URL</dt>
	<dd><input name="image" class="form-control" type="text" value="<?php echo $award->image;?>" />
