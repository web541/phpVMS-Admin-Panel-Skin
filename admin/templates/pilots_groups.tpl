	...
	<tr>
		...
		{ ?>
			<button href="<?php echo adminaction('/pilotadmin/viewpilots');?>" pilotid="<?php echo $pilotid;?>" 
				...
				class="pilotgroupajax button btn btn-danger {button:{icons:{primary:'ui-icon-trash'}}}">Remove</button></td>
		<?php
		} ?>
	</tr>		
...
<dl>
	<dt>Select Group:</dt>
	<dd><select class="form-control" name="groupname">
		<?php
		for($i=0;$i<$total;$i++)
		{
	...
	<dd><input type="hidden" name="pilotid" value="<?php echo $pilotid;?>" />
		...
		<input type="submit" name="submit" class="btn btn-success" value="Add to Group" /></dd>
</dl>
</form>
<?php
}
