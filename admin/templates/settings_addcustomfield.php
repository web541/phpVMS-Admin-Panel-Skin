...
<dl>
	<dt>Title</dt>
	<dd><input class="form-control" type="text" name="title" value="<?php echo $field->title ?>" /></dd>
	...
	<dt>Default value</dt>
	<dd>
		<input class="form-control" type="text" name="value" value="<?php echo $field->value; ?>" />
	...
	<dd>
		<select class="form-control" name="showinregistration">
