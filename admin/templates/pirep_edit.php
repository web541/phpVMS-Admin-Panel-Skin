...
<tr>	
	...
	<td><input class="form-control" type="text" name="flightnum" value="<?php echo $pirep->flightnum ?>" /></td>
</tr>
<tr>	
	<td style="font-weight: bold;">Select Departure Airport:</td>
	<td>
		<div id="depairport">
		<input name="depicao" class="form-control" value="<?php echo $pirep->depicao;?>" onclick="" />
		</div>
	</td>
</tr>
<tr>	
	...
	<td>
		<div id="arrairport">
		<input name="arricao" class="form-control" value="<?php echo $pirep->arricao;?>" onclick="" />
		</div>
	</td>
</tr>
<tr>	
...
<tr>		
	...
	<td><input type="text" class="form-control" name="flighttime" value="<?php echo $pirep->flighttime; ?>" />
...
<tr>	
	...
	<td><input type="text" class="form-control" name="load" value="<?php echo $pirep->load; ?>" />
		<p>This is the load of this flight. It's automatically determined, though you can adjust it here</p></td>
</tr>
<tr>		
	<td style="font-weight: bold;">Price</td>
	<td><input type="text" class="form-control" name="price" value="<?php echo $pirep->price; ?>" />
		<p>This is the price per load unit for this flight.</p></td>
</tr>
<tr>	
	<td style="font-weight: bold;">Fuel Used</td>
	<td><input type="text" class="form-control" name="fuelused" value="<?php echo $pirep->fuelused; ?>" />
...
<tr>		
	...
	<td><input type="text" class="form-control" name="fuelunitcost" value="<?php echo $pirep->fuelunitcost?>" />
...
<tr>		
	...
	<td><input type="text" class="form-control" name="expenses" value="<?php echo $pirep->expenses?>" />
		<p>Additional expenses for this flight (catering, cleaning, etc)</p></td>
</tr>
<tr>		
	<td style="font-weight: bold;">Pilot Pay</td>
	<td><input type="text" class="form-control" name="pilotpay" value="<?php echo $pirep->pilotpay;?>" />
...
<tr>		
	...
	<td>
		...
		<textarea class="form-control" name="comment" style="width: 50%; height: 150px"></textarea>
	</td>
</tr>
	<?php
	if($pirep->log != '')
...
<td><input type="hidden" name="pirepid" value="<?php echo $pirep->pirepid;?>" />
	...
	<input type="submit" name="submit_pirep" class="btn btn-info" value="Save PIREP" />
	<input type="submit" name="submit_pirep" class="btn btn-success" value="Accept PIREP" />
	<input type="submit" name="submit_pirep" class="btn btn-danger" value="Reject PIREP" />
</td>
</tr>
</table>
</form>
