...
<tr>
	...
	<td align="center" width="1%" nowrap>
        <button href="<?php echo SITE_URL?>/admin/action.php/pilotadmin/pendingpilots" action="approvepilot"
			id="<?php echo $pilot->pilotid;?>" class="ajaxcall btn btn-success {button:{icons:{primary:'ui-icon-circle-check'}}}">Accept</button>
				
        <button href="<?php echo SITE_URL?>/admin/action.php/pilotadmin/pendingpilots" action="rejectpilot"
			id="<?php echo $pilot->pilotid;?>" class="ajaxcall btn btn-danger {button:{icons:{primary:'ui-icon-circle-close'}}}">Reject</button>
        ...
        <button href="<?php echo SITE_URL?>/admin/action.php/pilotadmin/resendemail" action="resendemail"
			id="<?php echo $pilot->pilotid;?>" class="ajaxcall btn btn-info {button:{icons:{primary:'ui-icon-circle-close'}}}">Re-Send Activation Email</button>
        <?php
        }
        ?>
	</td>
