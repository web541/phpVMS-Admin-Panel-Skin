...
<p><strong>Subject: </strong><input class="form-control" type="text" name="subject" value="<?php if(isset($newsitem)) { echo $newsitem->subject; }?>" /></p>
<p>
<p><strong>News Text: </strong></p>
<p>
<textarea id="editor" class="form-control" name="body" width="100%" 
