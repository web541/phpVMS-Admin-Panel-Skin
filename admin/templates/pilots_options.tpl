...
<dl>
	...
	<dd><input type="hidden" name="pilotid" value="<?php echo $pilotid;?>" />
		...
		<input type="submit" name="submit" class="btn btn-info" value="Change Password" /></dd>
</dl>
</form>
<?php
...
<dl>	
	...
	<dd><input type="hidden" name="pilotid" value="<?php echo $pilotid;?>" />
		...
		<input type="submit" name="submit" class="btn btn-danger" onclick="return doublecheck();" value="Delete Pilot" /></dd>
</dl>
</form>
<?php
}
